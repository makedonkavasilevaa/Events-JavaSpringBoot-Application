...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public Users register(String username, String password, String repeatPassword, String name, String surname, Role role) {
        ...
        Users user = new Users(username, passwordEncoder.encode(password), name, surname, role);
